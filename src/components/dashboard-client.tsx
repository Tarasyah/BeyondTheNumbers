    ...
    <main className="space-y-16 p-4 md:p-8">
      ...
      <div className="text-center pb-8">
        <a
          ...
          className="inline-flex items-center justify-center px-8 py-3 text-lg font-semibold text-white rounded-md transition-all transform hover:scale-105 duration-300 ease-in-out hover:shadow-2xl hover:shadow-primary/60"
